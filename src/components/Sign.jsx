  ...
  <div class="grid grid-cols-1 lg:grid-cols-2">
    <div class="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
      <div class="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
        <h2 class="text-3xl font-bold leading-tight text-pink-600 sm:text-4xl">
          Sign in
        </h2>
        <p class="mt-2 text-sm text-gray-600">
          ...
          <a
            href="#"
            title=""
            class="font-semibold text-pink-400 transition-all duration-200 hover:underline"
          >
        ...
        <form action="#" method="POST" class="mt-8">
          <div class="space-y-5">
            ...
            <div>
              <button
                type="button"
                class="inline-flex w-full items-center justify-center rounded-md bg-pink-700 px-3.5 py-2.5 font-semibold leading-7 text-white hover:bg-pink-500"
              >
                Get started{" "}
                <svg
    ...
    <div class="h-full w-full">
      <img
        class="mx-auto h-[470px] w-[90%] mt-16 rounded-md object-cover"
